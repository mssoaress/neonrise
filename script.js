...
style.textContent = `* { cursor: none !important; } #cursor-ring { position: fixed; top: 0; left: 0; z-index: 99999; width: 36px; height: 36px; border-radius: 50%; border: 1.5px solid rgba(174,177,240,.55); pointer-events: none; transform: translate(-50%,-50%); transition: width .28s ease, height .28s ease, border-color .28s ease, background .28s ease, opacity .3s; will-change: transform; } #cursor-dot { position: fixed; top: 0; left: 0; z-index: 99999; width: 5px; height: 5px; border-radius: 50%; background: var(--lav-deep); pointer-events: none; transform: translate(-50%,-50%); transition: opacity .3s; will-change: transform; } #cursor-ring.hover { width: 56px; height: 56px; border-color: rgba(174,177,240,.8); background: rgba(174,177,240,.06); } #cursor-ring.click { width: 28px; height: 28px; background: rgba(174,177,240,.18); }`;
